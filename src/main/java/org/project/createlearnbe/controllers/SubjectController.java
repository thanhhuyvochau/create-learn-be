...
@Tag(
        ...
        description = "APIs for managing subjects, including creation, updating, retrieval, and deletion."
)
@RestController
...
public class SubjectController {
  ...
  @GetMapping
  public ResponseEntity<ApiWrapper<List<SubjectResponse>>> getAllSubjects() {
    return ResponseEntity.ok(ApiWrapper.success(subjectService.getAll()));
  }

  @Operation(
          summary = "Create a new subject",
          description = "Creates a new subject with an uploaded icon image. Accepts multipart/form-data."
  )
  @ApiResponses({
          @ApiResponse(
                  responseCode = "200",
