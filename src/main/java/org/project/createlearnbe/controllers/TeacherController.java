...
@Tag(
        ...
        description = "APIs for managing teachers including create, update, delete, and retrieve operations."
)
@RestController
...
public class TeacherController {
    ...
    @Operation(
            ...
            description = "Creates a new teacher profile in the system with basic details such as name, email, and experience."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Updates an existing teacher’s profile with new information such as subject, experience, or contact details."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
