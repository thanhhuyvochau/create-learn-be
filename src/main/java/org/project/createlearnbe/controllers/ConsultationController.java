...
public class ConsultationController {
  ...
  @Operation(
      ...
      description =
          "Submit a consultation request. Typically used by users to contact or schedule discussions.")
  @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retrieve a list of all consultation requests. Usually restricted to admin users.")
  @ApiResponse(
      responseCode = "200",
