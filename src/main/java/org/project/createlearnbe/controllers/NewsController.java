...
public class NewsController {
  ...
  @Operation(
      ...
      description = "Retrieve all news entries, including hidden ones. Requires admin privileges.")
  @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
      ...
      description = "Retrieve a specific news item by its ID. Admin access required.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      summary = "Get all public news",
      description = "Retrieve all visible (public) news for end users.")
  @ApiResponse(
      responseCode = "200",
      description = "Public news list retrieved successfully",
      content = @Content(schema = @Schema(implementation = NewsResponse.class)))
  @GetMapping("/public")
  public ResponseEntity<ApiWrapper<ApiPage<NewsResponse>>> getAllPublicNews(Pageable pageable) {
    return ResponseEntity.ok(
        ApiWrapper.success(ApiPage.of(newsService.getAllVisibleNews(pageable))));
  }
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Public news retrieved successfully",
        content = @Content(schema = @Schema(implementation = NewsResponse.class))),
  ...
  @Operation(
      ...
      description = "Create a new news item. Content field supports rich HTML text.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description = "Update the details of an existing news entry by its ID.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      summary = "Delete news",
      description = "Delete a news entry by its ID. Only accessible to admin users.")
  @ApiResponses({
